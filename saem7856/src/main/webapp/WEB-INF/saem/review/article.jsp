...
<script type="text/javascript">
		...
		$(".btnSendReviewLike")
				.click(
						function() {
							...
							var url = "${pageContext.request.contextPath}/review/insertReviewLike.do";
							var num = "${dto.num}";
	...
	function listPage(page) {
		var url = "${pageContext.request.contextPath}/review/listReply.do";
		...
		$(".btnSendReply")
				.click(
						function() {
							...
							var url = "${pageContext.request.contextPath}/review/insertReply.do";
		...
		$("body")
				.on(
						...
						function() {
							...
							var url = "${pageContext.request.contextPath}/review/deleteReply.do";
		...
		$("body")
				.on(
						...
						function() {
							...
							var url = "${pageContext.request.contextPath}/review/insertReplyLike.do";
	...
	function listReplyAnswer(answer) {
		var url = "${pageContext.request.contextPath}/review/listReplyAnswer.do";
	...
	function countReplyAnswer(answer) {
		var url = "${pageContext.request.contextPath}/review/countReplyAnswer.do";
		var query = "answer=" + answer;
		...
		$("body")
				.on(
						...
						function() {
							...
							var url = "${pageContext.request.contextPath}/review/insertReplyAnswer.do";
							var query = "num=" + num + "&content=" + content
									+ "&answer=" + replyNum;
		...
		$("body")
				.on(
						...
						function() {
							...
							var url = "${pageContext.request.contextPath}/review/deleteReplyAnswer.do";
							var query = "replyNum=" + replyNum;
						...
						<table class="table table-border table-article">
											...
											<ul class="slider">
												<c:forEach var="dto" items="${listFile}">
													<li data-num="${dto.num}"><img
														src="${pageContext.request.contextPath}/uploads/review/${dto.imageFilename}"
														title="${dto.subject}" alt="${dto.subject}"
														onclick="imageViewer('${pageContext.request.contextPath}/uploads/review/${dto.imageFilename}');"></li>
												</c:forEach>
											</ul>
										</c:when>
										<c:otherwise>
											<div class="img-box" align="center">
												<c:forEach var="dto" items="${listFile}">
													<img
														src="${pageContext.request.contextPath}/uploads/review/${dto.imageFilename}"
														title="${dto.subject}" alt="${dto.subject}"
														onclick="imageViewer('${pageContext.request.contextPath}/uploads/review/${dto.imageFilename}');">
												</c:forEach>
											</div>
										</c:otherwise>
									</c:choose>
							...
							<tr>
								<td colspan="2" style="background-color: white;">다음글 : <c:if
										...
										<a
											href="${pageContext.request.contextPath}/review/article.do?num=${preReadDto.num}&page=${page}">${preReadDto.subject}</a>
									</c:if>
								</td>
							</tr>
							<tr>
								<td colspan="2" style="background-color: white;">이전글 : <c:if
										...
										<a
											href="${pageContext.request.contextPath}/review/article.do?num=${nextReadDto.num}&page=${page}">${nextReadDto.subject}</a>
									</c:if>
								</td>
							</tr>
							<tr>
								<td width="50%"><c:choose>
										<c:when
											...
											<button type="button" class="btn"
												onclick="location.href='${pageContext.request.contextPath}/review/update.do?num=${dto.num}&page=${page}';">수정</button>
										</c:when>
										<c:otherwise>
								...
								<td align="right">
									<button type="button" class="btn"
										onclick="location.href='${pageContext.request.contextPath}/review/list.do?page=${page}';">리스트</button>
								</td>
							</tr>
						</table>
