			...
			<div class="inner">
				...
				<main>
					<div class="body-container"
						style="width: 1100px; padding-top: 30px;">
						<div class="body-title">
							<h3>
								<i class="fas fa-chalkboard"></i> 리뷰 게시판
							</h3>
						</div>
							...
							<tr>
								<td width="100">
									<button type="button" class="button primary small"
										onclick="location.href='${pageContext.request.contextPath}/review/list.do';">새로고침</button>
								</td>
								<td align="center">
									<form name="searchForm"
										action="${pageContext.request.contextPath}/review/list.do"
								...
								<td align="right" width="100">
									<button type="button" class="button primary small"
										onclick="location.href='${pageContext.request.contextPath}/review/write.do';">글올리기</button>
								</td>
							</tr>
						</table>
