						...
						<c:forEach var="dto" items="${list}" varStatus="status">
							<article>			 
								<span style="float: left; padding-right: 25px;">
									<img src="${pageContext.request.contextPath}/uploads/articlePhoto/${dto.imageFilename}" onclick="location.href='${pageContext.request.contextPath}/article/article.do?page=1&num=${dto.num}';">
								</span>
								<div class="content" >
									...
									<p style=" white-space:normal; text-overflow: ellipsis; width:50%; height: 250px; overflow: hidden;">${dto.content}</p>
								</div>
							</article>	
						</c:forEach>					
					</div>
